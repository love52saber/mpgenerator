...
public class ConfigBuilder {
    ...
    private List<TableInfo> processTable(List<TableInfo> tableList, NamingStrategy strategy, StrategyConfig config) {
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            if (StringUtils.isNotEmpty(globalConfig.getConstantName())) {
                tableInfo.setConstantName(String.format(globalConfig.getConstantName(), entityName));
            } else {
                tableInfo.setConstantName(entityName + ConstVal.CONSTANT);
            }
    ...
    private List<TableInfo> getTablesInfo(StrategyConfig config) {
        ...
        try {
            ...
            // 获取每个字段的信息放入tableInfo.fieldList中
